    ...
    return (
        <>
            ...
            <TopicBody>
                ...
                <Step type='info'>Swap for some using <ExternalLink title="app.uniswap.org/swap" to="https://app.uniswap.org/swap?chain=arbitrum" icon="uniswap-logo.png"/> on Arbitrum</Step>
